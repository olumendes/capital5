...
export default function GoalProjectionModal({ goal, children, open, onOpenChange }: GoalProjectionModalProps) {
  ...
  const calculateProjection = () => {
    ...
    try {
      ...
      if (useFGTS) {
        currentAmount += fgtsBalance;
      }

      const remainingAmount = Math.max(0, goal.targetAmount - currentAmount);
      const totalProjected = currentAmount + (monthlySavings * monthsRemaining);
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="monthSelect">Selecione o Mês da Simulação</Label>
              ...
              {fgtsBalance > 0 && (
                <div className="border rounded-lg p-4 bg-blue-50">
                  ...
                  <p className="text-xs text-blue-700 mt-2">
                    Marcando esta opção, o saldo de FGTS será considerado como valor inicial do objetivo.
                  </p>
                </div>
              )}
